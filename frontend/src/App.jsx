      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8">
        ...
        >
          <input
            ...
            placeholder="Welche Todo's haben wir?"
            required
          />
          <button
            type="submit"
            className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md font-medium cursor-pointer"
          >
            Add Task
          </button>
        </form>
                ...
                <div key={todo._id}>
                  {editingTodo === todo._id ? (
                    <div className="flex items-center gap-x-3">
                      <input
                        className="flex-1 p-3 border rounded-lg border-gray-200 outline-none focus:ring-2 focus:ring-gray-300 text-gray-700 shadow-inner"
                        type="text"
                        value={editedText}
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-x-2">
                          <button
                            className="p-2 text-gray-400 hover:text-gray-700 rounded-lg hover:bg-gray-50 duration-200"
